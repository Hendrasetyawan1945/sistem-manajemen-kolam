<x-layouts.coach>
    <x-page-header 
        title="Tambah Catatan Waktu Lomba"
        subtitle="Catat waktu lomba siswa di kejuaraan"
        :breadcrumbs="[
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Catatan Waktu Lomba</h6>
        </div>
        <div class="card-body">
            <x-alert />

            <form action="{{ route('coach.catatan-waktu.store') }}" method="POST">
                @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <select name="kejuaraan_id" id="kejuaraan_id" class="form-control @error('kejuaraan_id') is-invalid @enderror" required>
                                ...
                                @foreach($kejuaraanList as $kejuaraan)
                                    <option value="{{ $kejuaraan->id }}" {{ old('kejuaraan_id') == $kejuaraan->id ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <textarea name="keterangan" id="keterangan" rows="2" class="form-control @error('keterangan') is-invalid @enderror" placeholder="Keterangan tambahan...">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="alert alert-info">
                    ...
                    Personal Best siswa akan otomatis diperbarui jika waktu ini lebih baik dari catatan sebelumnya.
                </div>
