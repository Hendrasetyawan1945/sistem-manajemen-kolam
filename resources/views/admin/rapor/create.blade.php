<x-layouts.admin>
    <x-page-header 
        title="Tambah Rapor"
        subtitle="Buat rapor penilaian siswa"
        :breadcrumbs="[
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="catatan_coach" id="catatan_coach" rows="4" class="form-control @error('catatan_coach') is-invalid @enderror" placeholder="Catatan dan saran untuk siswa (opsional)">{{ old('catatan_coach') }}</textarea>
                            @error('catatan_coach')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
