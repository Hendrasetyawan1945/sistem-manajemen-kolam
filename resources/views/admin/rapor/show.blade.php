        ...
        <div class="col-md-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3 d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('admin.rapor.pdf', $rapor) }}" class="btn btn-sm btn-danger" target="_blank">
                            <i class="fas fa-file-pdf"></i> Export PDF
                        </a>
                        <a href="{{ route('admin.rapor.edit', $rapor) }}" class="btn btn-sm btn-warning">
                            <i class="fas fa-edit"></i> Edit
                        </a>
                        <form action="{{ route('admin.rapor.destroy', $rapor) }}" method="POST" class="d-flex" onsubmit="return confirm('Yakin ingin menghapus rapor ini?')">
                            @csrf
                            @method('DELETE')
