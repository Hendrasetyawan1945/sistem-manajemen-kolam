<x-layouts.admin>
    <x-page-header 
        title="Tambah Ukuran Jersey"
        subtitle="Tambah ukuran jersey baru ke master data"
        :breadcrumbs="[
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Ukuran Jersey</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.master-ukuran-jersey.store') }}" method="POST">
                @csrf
