<x-layouts.admin>
    <x-page-header 
        ...
        subtitle="Buat data kejuaraan baru"
        :breadcrumbs="[
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.kejuaraan.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <textarea name="deskripsi" id="deskripsi" rows="4" class="form-control @error('deskripsi') is-invalid @enderror" placeholder="Deskripsi kejuaraan (opsional)">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
